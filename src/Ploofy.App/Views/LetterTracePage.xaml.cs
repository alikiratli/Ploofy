...
public partial class LetterTracePage : ContentPage
{
    private readonly LetterTraceViewModel _viewModel;

    public LetterTracePage(LetterTraceViewModel viewModel)
    {
        InitializeComponent();
    ...
    private void OnRoundReady(object? sender, LetterTraceRound round) => Surface.Start(round);
    ...
    {
        // Yüzey biten harfi zaten kutlama süresince gösterdi; buradaki kısa
